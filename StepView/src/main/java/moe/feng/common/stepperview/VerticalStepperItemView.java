...
public class VerticalStepperItemView extends FrameLayout {
    ...
    public VerticalStepperItemView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            if (a.hasValue(R.styleable.VerticalStepperItemView_step_summary_icon)) {
                Drawable summaryIcon = a.getDrawable(R.styleable.VerticalStepperItemView_step_summary_icon);
                summaryIcon.setBounds(0, 0, summaryIcon.getMinimumWidth(), summaryIcon.getMinimumHeight());
                mSummaryText.setCompoundDrawables(summaryIcon, null, null, null);
            }
    ...
    public synchronized void setState(@State int state) {
        ...
        if (mPointColorAnimator != null)
            mPointColorAnimator.cancel();
        ...
        if (mTitleColorAnimator != null)
            mTitleColorAnimator.cancel();
        ...
        if (mErrorText != null) {
            ...
            if (mSummaryColorAnimator != null)
                mSummaryColorAnimator.cancel();
            ...
            if (mErrorIconView.getAlpha() < 1F) {
                ...
                if (mErrorIconAnimator != null)
                    mErrorIconAnimator.cancel();
     ...
     */
    public @Nullable
    CharSequence getSummaryFinished() {
    ...
    public void setErrorColor(@ColorInt int color) {
        ...
        if (mErrorText != null && color != mErrorColor) {
            if (mTitleColorAnimator != null && mTitleColorAnimator.isRunning())
                mTitleColorAnimator.cancel();
            if (mSummaryColorAnimator != null && mSummaryColorAnimator.isRunning())
                mSummaryColorAnimator.cancel();
