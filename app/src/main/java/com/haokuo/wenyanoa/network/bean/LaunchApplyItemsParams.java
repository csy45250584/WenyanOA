...
public class LaunchApplyItemsParams extends MatterBaseParams {
    ...
    public LaunchApplyItemsParams(int userId, String apiKey, int onelevelId, int twolevelId, int threelevelId, int courtesyCopyId, String items_name, String incident) {
